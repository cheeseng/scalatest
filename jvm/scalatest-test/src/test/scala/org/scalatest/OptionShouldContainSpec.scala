    ...
    describe("when used with not contain value syntax") {
      ...
      it("should use an explicitly provided Equality") {
        ...
        intercept[TestFailedException] {
          ...
          // SKIP-DOTTY-END
          //DOTTY-ONLY (all (hiSomes) should not contain "HI") (using decided by defaultEquality afterBeing lowerCased)
        }
        intercept[TestFailedException] {
          // SKIP-DOTTY-START
          (all (hiSomes) should not contain "HI ") (after being trimmed and lowerCased)
          // SKIP-DOTTY-END
          //DOTTY-ONLY (all (hiSomes) should not contain "HI ") (using after being trimmed and lowerCased)
        }
      }
      it("should do nothing when used with null and LHS did not contain null value") {
