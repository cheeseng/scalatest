...
class NotWordSpec extends AnyFunSpec with FileMocks {
  ...
  describe("NotWord ") {
    ...
    describe("contain(ResultOfAWordToAMatcherApplication) method returns Matcher") {
      ...
      it("should have correct MatcherResult") {
        mr.matches shouldBe false
        mr.failureMessage shouldBe s"$leftList contained a file: " + s"$myFile was a file"
        mr.negatedFailureMessage shouldBe s"$leftList did not contain a file"
        mr.midSentenceFailureMessage shouldBe s"$leftList contained a file: " + s"$myFile was a file"
      ...
      it("should have correct negated MatcherResult") {
        ...
        nmr.negatedFailureMessage shouldBe s"$leftList contained a file: " + s"$myFile was a file"
        nmr.midSentenceFailureMessage shouldBe s"$leftList did not contain a file"
        nmr.midSentenceNegatedFailureMessage shouldBe s"$leftList contained a file: " + s"$myFile was a file"
    ...
    describe("contain(ResultOfAnWordToAnMatcherApplication) method returns Matcher") {
      ...
      it("should have correct MatcherResult") {
        mr.matches shouldBe false
        mr.failureMessage shouldBe s"$leftList contained an file: " + s"$myFile was an file"
        mr.negatedFailureMessage shouldBe s"$leftList did not contain an file"
        mr.midSentenceFailureMessage shouldBe s"$leftList contained an file: " + s"$myFile was an file"
      ...
      it("should have correct negated MatcherResult") {
        ...
        nmr.negatedFailureMessage shouldBe s"$leftList contained an file: " + s"$myFile was an file"
        nmr.midSentenceFailureMessage shouldBe s"$leftList did not contain an file"
        nmr.midSentenceNegatedFailureMessage shouldBe s"$leftList contained an file: " + s"$myFile was an file"
