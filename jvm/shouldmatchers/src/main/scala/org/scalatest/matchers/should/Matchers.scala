 ...
 * available in scope.
 * Similarly, the <code>size</code> syntax can be used with <code>Array</code>, any <code>scala.collection.Iterable</code>,
...
*/
  ...
  private[scalatest] def doCollected[T](collected: Collected, xs: scala.collection.Iterable[T], original: Any, prettifier: Prettifier, pos: source.Position)(fun: T => Assertion): Assertion = {
   ...
   * @author Chee Seng
   */
  final class ResultOfNotWordForCollectedAny[T](collected: Collected, xs: scala.collection.Iterable[T], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
    ...
    // SKIP-DOTTY-END  
      ...
      doCollected(collected, xs, original, prettifier, pos) { e =>
        if (aggregating.containsOnly(e, right) != shouldBeTrue) {
          val withFriendlyReminder = right.size == 1 && (right(0).isInstanceOf[scala.collection.Iterable[_]] || right(0).isInstanceOf[Every[_]])
          indicateFailure(
            if (shouldBeTrue)
   ...
   * @author Chee Seng
   */
  final class ResultOfContainWordForCollectedAny[T](collected: Collected, xs: scala.collection.Iterable[T], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
   ...
   * @author Chee Seng
   */
  sealed class ResultOfBeWordForCollectedAny[T](collected: Collected, xs: scala.collection.Iterable[T], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
   ...
   * @author Chee Seng
   */
  final class ResultOfBeWordForCollectedArray[T](collected: Collected, xs: scala.collection.Iterable[Array[T]], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position)
   ...
   * @author Chee Seng
   */
  final class ResultOfCollectedAny[T](collected: Collected, xs: scala.collection.Iterable[T], original: Any, prettifier: Prettifier, pos: source.Position) {
...
*/
   ...
   * @author Bill Venners
   */
  final class ResultOfHaveWordForCollectedExtent[A](collected: Collected, xs: scala.collection.Iterable[A], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
   ...
   * @author Chee Seng
   */
  final class ResultOfStartWithWordForCollectedString(collected: Collected, xs: scala.collection.Iterable[String], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
   ...
   * @author Chee Seng
   */
  final class ResultOfIncludeWordForCollectedString(collected: Collected, xs: scala.collection.Iterable[String], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
   ...
   * @author Chee Seng
   */
  final class ResultOfEndWithWordForCollectedString(collected: Collected, xs: scala.collection.Iterable[String], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
   ...
   * @author Chee Seng
   */
  final class ResultOfFullyMatchWordForCollectedString(collected: Collected, xs: scala.collection.Iterable[String], original: Any, shouldBeTrue: Boolean, prettifier: Prettifier, pos: source.Position) {
  ...
  /**
    * This method enables the following syntax for <code>scala.collection.Map</code>:
    *
    * <pre class="stHighlight">
    ...
    * </pre>
    */
  def all[K, V, MAP[k, v] <: scala.collection.Map[k, v]](xs: MAP[K, V])(implicit collecting: Collecting[(K, V), scala.collection.Iterable[(K, V)]], prettifier: Prettifier, pos: source.Position): ResultOfCollectedAny[(K, V)] =
    new ResultOfCollectedAny(AllCollected, collecting.iterableFrom(xs), xs, prettifier, pos)
  ...
  /**
    ...
    * </pre>
    */
  def atLeast[K, V, MAP[k, v] <: scala.collection.Map[k, v]](num: Int, xs: MAP[K, V])(implicit collecting: Collecting[(K, V), scala.collection.Iterable[(K, V)]], prettifier: Prettifier, pos: source.Position): ResultOfCollectedAny[(K, V)] =
    new ResultOfCollectedAny(AtLeastCollected(num), collecting.iterableFrom(xs), xs, prettifier, pos)
  ...
  /**
    ...
    * </pre>
    */
  def every[K, V, MAP[k, v] <: scala.collection.Map[k, v]](xs: MAP[K, V])(implicit collecting: Collecting[(K, V), scala.collection.Iterable[(K, V)]], prettifier: Prettifier, pos: source.Position): ResultOfCollectedAny[(K, V)] =
    new ResultOfCollectedAny(EveryCollected, collecting.iterableFrom(xs), xs, prettifier, pos)
  ...
  /**
    ...
    * </pre>
    */
  def exactly[K, V, MAP[k, v] <: scala.collection.Map[k, v]](num: Int, xs: MAP[K, V])(implicit collecting: Collecting[(K, V), scala.collection.Iterable[(K, V)]], prettifier: Prettifier, pos: source.Position): ResultOfCollectedAny[(K, V)] =
    new ResultOfCollectedAny(ExactlyCollected(num), collecting.iterableFrom(xs), xs, prettifier, pos)
  ...
  /**
    ...
    * </pre>
    */
  def atMost[K, V, MAP[k, v] <: scala.collection.Map[k, v]](num: Int, xs: MAP[K, V])(implicit collecting: Collecting[(K, V), scala.collection.Iterable[(K, V)]], prettifier: Prettifier, pos: source.Position): ResultOfCollectedAny[(K, V)] =
    new ResultOfCollectedAny(AtMostCollected(num), collecting.iterableFrom(xs), xs, prettifier, pos)
